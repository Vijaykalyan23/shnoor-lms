  ...
  return (
    <div className="p-6">
      <div className="flex-between-center mb-xl">
        ...
        <div className="text-sm px-3 py-1 rounded-full border font-medium" style={{ background: '#DBEAFE', color: '#003B5C', borderColor: '#BFDBFE' }}>
          Instructor Portal
        </div>
      </div>
      ...
      <div className="grid-3">
        <div className="stat-card" style={{ borderLeft: '4px solid #E8AA25' }}>
          <div className="flex-between-center">
            ...
            <div className="stat-icon" style={{ background: '#FEF3C7', color: '#C58A12' }}>
              <FaBookOpen size={24} />
            </div>
          </div>
        </div>
        ...
        <div className="stat-card" style={{ borderLeft: '4px solid #003B5C' }}>
          <div className="flex-between-center">
            ...
            <div className="stat-icon" style={{ background: '#DBEAFE', color: '#003B5C' }}>
        ...
        <div className="stat-card" style={{ borderLeft: '4px solid #E8AA25' }}>
          <div className="flex-between-center">
            <div>
              ...
              <div className="stat-number">{stats.avgRating} <span className="text-sm font-normal text-gray-400">/ 5</span></div>
            </div>
            <div className="stat-icon" style={{ background: '#FEF3C7', color: '#C58A12' }}>
              <FaStar size={24} />
            </div>
      ...
      <div className="grid-2" style={{ marginBottom: '2rem' }}>
        <div className="form-box full-width">
          <div className="flex-between-center mb-md">
            <h3 className="section-title mb-0">Student Performance Analytics</h3>
            <button
      ...
      <div className="grid-3">
        ...
        >
          <div style={{ background: '#eff6ff', padding: '12px', borderRadius: '50%', color: '#3b82f6' }}><FaPlus /></div>
          <div>
            <div style={{ fontWeight: '600', color: '#1f2937' }}>Create New Course</div>
            <div style={{ fontSize: '0.8rem', color: '#6b7280' }}>Start building content</div>
          </div>
        </button>
        ...
        <button
          ...
          onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}
        >
          <div style={{ background: '#fef3c7', padding: '12px', borderRadius: '50%', color: '#d97706' }}><FaFolderOpen /></div>
          <div>
            <div style={{ fontWeight: '600', color: '#1f2937' }}>Manage Courses</div>
            <div style={{ fontSize: '0.8rem', color: '#6b7280' }}>View/Edit your library</div>
          </div>
        </button>
        ...
        <button
          ...
          onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}
        >
          <div style={{ background: '#d1fae5', padding: '12px', borderRadius: '50%', color: '#059669' }}><FaEnvelope /></div>
          <div>
            <div style={{ fontWeight: '600', color: '#1f2937' }}>Message Students</div>
            <div style={{ fontSize: '0.8rem', color: '#6b7280' }}>Broadcast announcements</div>
          </div>
        </button>
      </div>
    </div>
